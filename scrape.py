...
"""The script then aggregates all the scraped content from the URLs. 
This is achieved with the scrape_all_content() function, which iteratively calls scrape_page_content() for each URL and extracts its text. 
This collected text is then saved to a file."""
